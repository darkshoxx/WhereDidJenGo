...
class QuestionDetailViewTests(TestCase):
    ...
    def test_past_questions(self):
        """Detail view of past questions should be shown."""
...
class QuestionModelTests(TestCase):
    def test_was_published_recently_with_future_question(self):
        """The method was_published_recently() returns False for questions
            whose pub_date is in the Future."""
        future_time = timezone.now() + datetime.timedelta(days=30)
        future_question = Question(
            question_text="Question from the future?",
            pub_date=future_time
        )
        self.assertIs(future_question.was_published_recently(), False)

    def test_was_published_recently_with_recent_question(self):
        """The method was_published_recently() returns True for questions
            whose pub_date is in the 5 minutes ago."""
    ...
    def test_was_published_recently_with_old_question(self):
        """The method was_published_recently() returns False for questions
            whose pub_date is in the older than 1 day."""
